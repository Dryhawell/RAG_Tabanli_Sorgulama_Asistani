...
- Judge: mute export revoke confirm modal
- Ingest: dual-write quarantine sidecar rotate PagerDuty on fail
- Observability: silence burn Grafana annotation Opsgenie deep-link
