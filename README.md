...
- Judge: mute export revoke fan-out audit Grafana annotate
- Ingest: dual-write quarantine sidecar rotate notify digest thread channel
- Observability: silence burn folder active time intervals
