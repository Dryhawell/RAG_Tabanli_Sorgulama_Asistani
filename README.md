...
- Judge: mute export revoke fan-out Grafana annotation panel
- Ingest: dual-write quarantine sidecar rotate notify digest thread reply broadcast
- Observability: silence burn folder inhibition by mute window
