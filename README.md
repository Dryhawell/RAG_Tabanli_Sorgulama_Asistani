...
- Judge: mute export revoke fan-out audit retention
- Ingest: dual-write quarantine sidecar rotate notify digest thread persist
- Observability: silence burn folder mute time intervals
