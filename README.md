...
- Judge: mute export signed URL revoke + audit trail
- Ingest: dual-write quarantine sidecar cert auto-rotate hook
- Observability: silence burn Slack page link + PagerDuty runbook field
