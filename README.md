...
- Judge: mute snapshot export retention + signed artifact URL
- Ingest: dual-write quarantine sidecar mTLS cert-expiry alert
- Observability: inhibit equal silence burn runbook + amtool page
