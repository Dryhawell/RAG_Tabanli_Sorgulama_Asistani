...
- Judge: mute export revoke canvas fan-out audit trail
- Ingest: dual-write quarantine sidecar rotate notify digest thread
- Observability: silence burn Alertmanager folder receiver policy
